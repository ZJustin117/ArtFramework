...
- Connector lifecycle is available to device-lab operations when requested. Harness and Arthas may start, stop, restart, and check the daemon on `STS_CONNECTOR_PORT`; concurrent debugging is intentionally not serialized.
