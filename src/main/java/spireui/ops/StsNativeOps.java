 ...
 * {@link spireui.api.SpireUI#setNativeOpsBackend}. Safe no-op style errors when not in game.
 */
        ...
        Gdx.app.postRunnable(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    BaseMod.logger.warn("SpireUI event option failed: " + t.getMessage());
                }
            }
        });
        ...
        Gdx.app.postRunnable(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    BaseMod.logger.warn("SpireUI end turn failed: " + t.getMessage());
                }
            }
        });
